...
//        }
    ...
    private fun runTun2socks() {
        ...
        // Always include the misc section with recommended values
        configBuilder.append("\nmisc:\n")
        ...
        if (MmkvManager.decodeSettingsBool(AppConfig.PREF_LOCAL_DNS_ENABLED)) {
            ...
            // Additional DNS specific configs can be added here if needed
        }
        ...
        val cmd = arrayListOf(
            ...
            mInterface.fileDescriptor.toString()  // Pass the actual integer value of the file descriptor
        )
        ...
        try {
            ...
            // No need to write to process stdin - file descriptor is passed as a command line argument
